    ...
    <main className="[background:linear-gradient(180deg,_#ffeeba,_#ffdd87)] mx-auto">
      ...
      <div className="home w-full min-h-screen overflow-scroll text-left text-[13.16px] text-grey flex">
        <div className="flex flex-col md:flex-row md:justify-between mx-auto content-center">
          <div className="home-two md:sticky relative order-2 z-10 md:bg-inherit lg:bg-inherit bg-[#ffe59f] md:mt-0 mt-[22rem] md:order-1 h-[539px] text-[66.43px] text-gray-100">
                ...
                <div className="leading-[42.75px] text-[#2F1931]">
                  <div className="flex items-center">
                    <img
                      ...
                      src="./coinslot.svg"
                    />
                    <p className="ml-2 mt-3 font-rooney">20c max fee</p>
                  </div>
                  <div className="flex items-center mt-2">
                    ...
                    />
                    <span className="flex">
                      <p className="ml-2 md:ml-4 font-rooney">Instant</p>
                      <p className="light-font">&nbsp;transactions</p>
                    </span>
                  </div>
                  <div className="flex items-center mt-2">
                    <img
                      className="w-[33.71px] h-[33.65px] md:max-w-full max-h-full"
                      alt=""
                      src="./group-75.svg"
                    />
                    <p className="ml-4 font-rooney">Full self&#45;custody</p>
                  </div>
                </div>
